...
onready var tucaCountLabel = $Control/MarginContainer/HBox1/Hbox2/tucaRect/tucaCountLab
onready var coinCount = $Control/MarginContainer/HBox1/Hbox2/coinRect/coinCountLabel
